    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Discover, invite, and collaborate with team members</p>
        </div>
        ...
        <TabsContent value="sent" className="space-y-4">
          ...
          {sentInvites.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">Invite users from the Discover tab to build your team</p>
            </div>
          )}
        </TabsContent>
